...
//  } 
  ...
  gst_bin_add_many (GST_BIN (pipeline), video_source, video_sink, NULL); 
  /* we link the elements together */ 
  gst_element_link_many (video_source, video_sink, NULL); 

  gst_bin_add_many (GST_BIN (pipeline), audio_source, audio_convert, audio_sink, NULL); 
  /* we link the elements together */ 
  gst_element_link_many (audio_source, audio_convert, audio_sink, NULL); 
